...
public class EarthFighterGen1_MonsterController : MonoBehaviour
{
    public GameObject Report;
    private GameObject ReportRefference;

    private string prefabLocation = "Prefabs/MonsterStuff/Monsters/Gen 1/BeefMaster_Gen1";
    ...
    void Start()
    {
        ...
        monster = new Monster("BeefMaster_Gen1", prefabLocation, MonsterType.Fighter);
    ...
    private void Devolution()
    {
        if (monster.DeathStatus)
        {
            if (!thisAnimator.GetBool("Deevolving"))
            {
                ...
                thisAnimator.Play("BeefMaster_DeEvolution");
