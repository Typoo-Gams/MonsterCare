...
public class WaterPlayfullGen1_MonsterController : MonoBehaviour
{
    ...
    private string prefabLocation = "Prefabs/MonsterStuff/Monsters/Gen 1/WaterPlayful_Gen1";
    ...
    void Start()
    {
        ...
        monster = new Monster("WaterPlayful_Gen1", prefabLocation, MonsterType.Playfull);
    ...
    private void Devolution()
    {
        if (monster.DeathStatus)
        {
            if (!thisAnimator.GetBool("Deevolving"))
            {
                ...
                thisAnimator.Play("WaterPlayful_DeEvolution");
