...
public class FoodManager_FoodObject : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        EatingAnimation = GameObject.FindGameObjectWithTag("Monster").GetComponent<Animator>();
    }
    ...
    void OnDestroy()
    {
        ...
        EatingAnimation.SetBool("EatingTrigger", false);
        EatingAnimation.SetBool("EatingTrigger", true);
